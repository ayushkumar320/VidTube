...
const registerUser = asyncHandler(async (req, res) => {
  ...
  // let coverImage = "";
  // if (coverLocalPath) {
  //   coverImage = await uploadOnCloudinary(cover);
  // }
  ...
  try {
    ...
    if (!createdUser) {
      throw new ApiError(
        500,
        "Somewthing went wrong while registering a user!"
      );
    }
...
const refreshAccessToken = asyncHandler(async (req, res) => {
  ...
  try {
    ...
    const options = {
      httpOnly: true,
      secure: pprocess.env.NODE_ENV === "production",
    };
...
export {registerUser, loginUser, refreshAccessToken, logoutUser, updateUserAvatar, updateUserCoverImage, changeCurrentPassword, getCurrentUser, updateAccountDetails};
